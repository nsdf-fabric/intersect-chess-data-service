...
class TestChessDataEgressCapabilityEvents:
    def test_capability_defines_new_measurement_event(self):
        """The capability should declare an event for new measurements."""
        assert hasattr(ChessDataEgressCapability, "intersect_sdk_events")
